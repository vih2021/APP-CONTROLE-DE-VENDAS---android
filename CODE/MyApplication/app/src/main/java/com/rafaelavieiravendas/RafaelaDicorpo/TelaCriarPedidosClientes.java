...
public class TelaCriarPedidosClientes extends AppCompatActivity {
    ...
    ArrayList<InformationItem> ListaDeItens = new ArrayList<>();
    private int ContagemItens;

    public static void setListaDeNomes(ArrayList<Pedido> lista){
        for(Pedido item : lista){
            Log.d("fds" , "" +item.getNome());
            ListaDeNomes.add(item.getNome());
        }
    }
        ...
        btn_registrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nome.isEmpty() | data.isEmpty()) {
                    ...
                    Snackbar snackbar = Snackbar.make(v,"Pedido Registrado com sucesso!", Snackbar.LENGTH_SHORT);
                    snackbar.setBackgroundTint(Color.WHITE);
                    snackbar.setTextColor(Color.BLACK);
                    snackbar.show();
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            finish();
                            Intent intent = new Intent(TelaCriarPedidosClientes.this, TelaPedidos.class);
...
// VERIFICAR ESSA CHAMAR POIS ELA PODE SER INUTIL
    ...
    public void descartar() {
        AlertDialog.Builder builder = new AlertDialog.Builder(TelaCriarPedidosClientes.this);
        builder.setTitle("Deseja descartar este Registro?");
        builder.setPositiveButton("sim",new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                TelaCriarPedidosClientes.this.finish();
            } });
    ...
    public void addItem(String id, int index){
        ...
        chipx.setOnCloseIconClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int i = 0; i < ListaDeItens.size(); i++ ) {
                    if (ListaDeItens.get(i).getIndex() == chipx.getId()) {
    ...
    private void Dialog_pedido(int position) {
        ...
        TextView tamanho = view.findViewById(R.id.tamanho);
        ...
        TextView produto = view.findViewById(R.id.produto);
        
        InformationItem item = null;

        for(int i = 0; i < ListaDeItens.size(); i++){
            if(ListaDeItens.get(i).getIndex() == position){
                item = ListaDeItens.get(i);
            }
        }

        tamanho.setText("Tamanho : " + item.getTamaho());
        cor.setText("Cor : " + item.getCor());
        preco.setText("Preço : " + item.getPreco());
        quantidade.setText("Quantidade : " + item.getQuantidade());
        produto.setText("Produto : " + item.getProduto());
    ...
    private void Dialog_pedido_item() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(TelaCriarPedidosClientes.this, R.style.CustomAlertDialog);
        //android.R.style.Theme_Translucent_NoTitleBar     deixa o dialog transparente
        ...
        view.findViewById(R.id.botao_adicionar).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String preco = preco_element.getText().toString().replace(".", "");
    ...
    private void IniciarComponentes(){
        //recycler_itens = findViewById(R.id.recycle_viewer);
        ...
        //chips = (Chip)findViewById(R.id.chip_item);
